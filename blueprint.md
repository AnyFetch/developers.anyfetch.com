...
+ Parameters
    ...
    + strict (optional, boolean, `false`) ... When using strict mode, only perfect results will be returned (a search for "John Doe" will never return documents about "Doe" only)
