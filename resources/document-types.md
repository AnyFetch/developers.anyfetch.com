...
If you're not satisfied with the default presentation or you find some data is missing, you can [create your own document-type](/guides/creating/document-type) and make a simple hydrater updating the "old" document-type to the new one.
